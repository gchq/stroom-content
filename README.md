...
| --------------------------------------------------------------------------------- | ------------ | ------------ |
| [v2.2](https://github.com/gchq/stroom-content/releases/tag/core-xml-schemas-v2.1) | Y            | Y            |
...
| Pack version                                                                                        | Stroom 5.0.x   | Stroom 6.0.x  |
| --------------------------------------------------------------------------------------------------- | -------------- | ------------- |
| [v0.2](https://github.com/gchq/stroom-content/releases/tag/template-pipelines-v0.3)                 | N              | N             |
